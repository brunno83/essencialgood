# ESSENCIAL GOOD - SAFE WRAPPER FOR APPLYING STAGING PATCH 004
...
$SqlFile = Join-Path $ScriptDir "004_visitor_restoration_rls_policies.sql"
...
Write-Host "Applying Staging Patch 004 to target project: $ProjectRef ..."
...
Write-Host "✅ Patch 004 successfully applied to Staging ($ProjectRef)."
