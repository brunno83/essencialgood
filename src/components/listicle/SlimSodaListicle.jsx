    ...
    <div className="listicle-slimsoda-wrapper" style={{ backgroundColor: 'var(--bg-page)', color: 'var(--color-primary)', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '840px', margin: '0 auto', padding: '30px 16px 20px' }}>
        ...
        <div style={{
          ...
          <img 
            src="/LISTICLE SLIMSODA/Imagens/slimsoda_hero_morning.jpg" 
        ...
        <section id="reason-1" style={{ marginBottom: '56px' }}>
          ...
          <div style={{
            ...
            <img 
              src="/LISTICLE SLIMSODA/Imagens/slimsoda_scoop_action.jpg" 
        ...
        <section style={{ marginBottom: '56px' }}>
          ...
          <div style={{
            ...
            <img 
              src="/LISTICLE SLIMSODA/Imagens/slimsoda_routine_comparison.jpg" 
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '32px', alignItems: 'center' }}>
            {/* PRODUCT IMAGE 03: slimsoda_product_tub.jpg */}
            <div style={{
              backgroundColor: 'var(--bg-card-alt)',
              borderRadius: 'var(--radius-md)',
              border: '1px solid var(--color-border)',
            ...
            <div style={{
              ...
              <div>
                ...
                <h2 style={{
                  ...
                  Simplify Your Morning. Support Your Daily Wellness. Take Your Routine Back.
                </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '24px' }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ height: '130px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px' }}>
                  <img
                    src="/assets/products/slimsoda-1.png"
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ height: '130px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px', marginTop: '6px' }}>
                  <img
                    src="/assets/products/slimsoda-2.png"
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ height: '130px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px' }}>
                  <img
                    src="/assets/products/slimsoda-3.png"
