    ...
    <div className="listicle-linfaflow-wrapper" style={{ backgroundColor: 'var(--bg-page)', color: 'var(--color-primary)', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '840px', margin: '0 auto', padding: '30px 16px 20px' }}>
        ...
        <div style={{
          ...
          <img 
            src="/LISTICLE - LINFAFLOW/Imagens/linfaflow-sec-1-why.jpg" 
        ...
        <section id="reason-1" style={{ marginBottom: '56px' }}>
          ...
          <div style={{
            ...
            <img 
              src="/LISTICLE - LINFAFLOW/Imagens/linfaflow_sec1_product_hero.jpg" 
              alt="LinfaFlow Liquid Dropper Bottle Highlight" 
              style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
              onError={(e) => {
                e.target.src = "/LISTICLE - LINFAFLOW/Imagens/linfaflow_sec_2_dropper_action.jpg";
              }}
            />
          </div>
        ...
        <section id="reason-2" style={{ marginBottom: '56px' }}>
          ...
          <div style={{
            ...
            <img 
              src="/LISTICLE - LINFAFLOW/Imagens/linfaflow_sec2_product_routine.jpg" 
            ...
            <div style={{
              ...
              <div>
                <div style={{
                  ...
                  <img 
                    src="/LISTICLE - LINFAFLOW/Imagens/gallery-botanicals.jpg" 
            ...
            <div style={{
              ...
              <div>
                <div style={{
                  ...
                  <img 
                    src="/LISTICLE - LINFAFLOW/Imagens/linfaflow-sec-3-ingredients.jpg" 
            ...
            <div style={{
              ...
              <div>
                <div style={{
                  ...
                  <img 
                    src="/LISTICLE - LINFAFLOW/Imagens/gallery-lifestyle.jpg" 
            ...
            <div style={{
              ...
              <div>
                <div style={{
                  ...
                  <img 
                    src="/LISTICLE - LINFAFLOW/Imagens/linfaflow-sec-2-benefits.jpg" 
        ...
        <section id="reason-4" style={{ marginBottom: '56px' }}>
          ...
          <div style={{
            ...
            <img 
              src="/LISTICLE - LINFAFLOW/Imagens/linfaflow-sec-5-howitworks.jpg" 
        ...
        <section id="reason-5" style={{ marginBottom: '56px' }}>
          ...
          <div style={{
            ...
            <img 
              src="/LISTICLE - LINFAFLOW/Imagens/linfaflow-sec-4-whychoose.jpg" 
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '32px', alignItems: 'center' }}>
            <div style={{
              ...
              <img 
                src="/LISTICLE - LINFAFLOW/Imagens/02-hero-bottle.webp" 
        ...
        <section className="ugc-banner-section">
          <div className="ugc-banner-grid" style={{
            ...
            <div className="ugc-banner-img-container" style={{
              ...
              <img 
                src="/LISTICLE - LINFAFLOW/Imagens/rev-07.jpg" 
            ...
            {[
              {
                ...
                verified: true,
                img: '/linfaflow/images/rev-01.jpg'
              },
              {
                id: 2,
                author: 'Laura K.',
                ...
                verified: true,
                img: '/linfaflow/images/rev-02.jpg'
              },
              {
                id: 3,
                author: 'Carla M.',
                ...
                verified: true,
                img: '/linfaflow/images/rev-03.jpg'
              },
              {
                id: 4,
                author: 'Patricia D.',
                ...
                verified: true,
                img: '/linfaflow/images/rev-04.jpg'
              }
            ].map((rev) => (
              <div
                key={rev.id}
            ...
            <div style={{
              ...
              <div>
                <div style={{ height: '130px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px' }}>
                  <img
                    src="/linfaflow/images/bundle-1.png"
